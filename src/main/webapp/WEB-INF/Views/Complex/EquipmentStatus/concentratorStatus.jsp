...
<div class="easyui-layout" fit="true">
	<div id="west" region="west" iconCls="icon-organization" split="true" title="设备" style="width: 284px;min-width:284px;height: 100%;">
		<%@include file="../../CommonTree/concentratorTree.jsp" %>
	</div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#dg').datagrid({
			url :'${pageContext.request.contextPath}/sysMonitor/concentratorStatus?Math.random()',
			queryParams: {
				id : 0,
				type : "",		
		    	status : "1"
			...
			toolbar : "#toolbar",
			columns: [[ 
				{title: '集中器地址', field: 'ammeterCode', width:'120px'},
				{title: '集中器名称', field: 'concentratorName', width:'160px'},
		        ...
		        {title: '离线时间', field: 'offlineTime', width:'140px'}, 
		        {title: '安装地址', field: 'address', width:'140px'}, 
		        {title: '坐标', field: 'location', width:'140px'},	        
			]]
		});
	})
