...
<div class="easyui-layout" fit="true">
	<div id="west" region="west" iconCls="icon-organization" split="true" title="设备" style="width: 284px;min-width:284px;height: 100%;">
		<%@include file="../../CommonTree/terminalTree.jsp" %>
	</div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#dg').datagrid({
			url :'${pageContext.request.contextPath}/sysMonitor/terminalStatus?Math.random()',
			queryParams: {
				id : 0,
				type : "",		
		    	status : "1"
			...
			toolbar : "#toolbar",
			columns: [[ 
				{title: '终端地址', field: 'ammeterCode', width:'120px'},
				{title: '终端名称', field: 'ammeterName', width:'160px'},
