   		...
   		<td style="width: 60%;">
   			<table class="detail_table">
				<tr>
					...
					<td rowspan="7">
			   			<label id="unknowntype" style="color:red;"></label>
			   		</td>
				</tr>
				<tr>
...
<!-- 终端列表弹出框 -->
<div id="unitdlg" class="easyui-dialog" style="width:800px;height:530px;" closable="true" closed="true" buttons="#unitdlg-buttons"
    data-options="">
...
<!-- 设备列表弹出框 -->
<div id="devicedlg" class="easyui-dialog" style="width:800px;height:530px;" closable="true" closed="true" buttons="#devicedlg-buttons"
    data-options="">
	<table id="devicedg"></table>
	<!-- 列表-按钮 -->
	<div id="devicetoolbar"> 
		<input type="hidden" id="systemtype" />
		<input type="hidden" id="subtype" />
		<div style="display: inline-block;">
     			<label style="font-size:14px">设备地址:</label>
			<input id="devicestatusaddress" class="easyui-textbox" style="width:160px;height:26px;" data-options="
                  prompt: '请输入地址……'"/>
     		</div>
     		<div style="display: inline-block;">
     			<label style="font-size:14px">设备名称:</label>
			<input id="devicestatusname" class="easyui-textbox" style="width:160px;height:26px;" data-options="
                  prompt: '请输入名称……'"/>
     		</div>
		<div style="display: inline-block;">
...
function unitInfo(typename,unittype,status) {
    ...
    opts.url = basePath + '/complex/unitFileInf?Math.random';
    opts.queryParams = {
    		id : $("#selectedID" , parent.document).val(),
			type : $("#selectedType" , parent.document).val(),
			nodeName : $("#selectedAddress" , parent.document).val(),
...
var statustype = $("#status").combobox("getValue");
    ...
    opts.url = basePath + '/complex/deviceFileInf?Math.random';
    opts.queryParams = {
    		id : $("#selectedID" , parent.document).val(),
			type : $("#selectedType" , parent.document).val(),
			nodeName : $("#selectedAddress" , parent.document).val(),
