...
<div class="easyui-layout" fit="true">
	...
	<div id="monthPanel" region="center" style="width:900px; height: 100%;">
		...
		<div id="toolbar"> 
	        ...
	        <label for="time">离线时间:</label>   
	        <input class="easyui-datetimebox" editable="fasle" style="width:155px;" type="text" id="starttime"  name="starttime" /> 
	        <label for="time">-</label>   
	        <input class="easyui-datetimebox" editable="fasle" style="width:155px;" type="text" id="endtime"  name="endtime" data-options="validType:'equaldDate[\'#starttime\']'"/> 
...
<script type="text/javascript">
	...
	$(function() {
		...
		var end = thisYear+'-'+thisMonth+'-'+thisDay+' 23:59:59';
		...
		$('#dg').datagrid({
			url :'${pageContext.request.contextPath}/sysMonitor/unitDropList?Math.random()',
			queryParams : {
				id : 0,
				type : "",
				nodeName : "",
