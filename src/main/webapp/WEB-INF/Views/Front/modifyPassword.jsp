...
<table class="editTable" frame="void"  rules="none" >
    <tr style="height: 38px; vertical-align: top;">
        <td class="textbox-label" style="width: 74px;"><spring:message code="UserName"/>:</td>
        <td><input class="easyui-textbox" type="text" id="name" name="name" value="${requestScope.username}"></td>
    </tr>
    <tr style="height: 38px; vertical-align: top;">
        <td class="textbox-label" style="width: 74px;"><spring:message code="OldPassword"/>:</td>
        <td><input class="easyui-passwordbox" type="text" id="oldpassword" name="oldpassword"></td>
    </tr>
    <tr style="height: 38px; vertical-align: top;">
        <td class="textbox-label" style="width: 74px;"><spring:message code="NewPassword"/>:</td>
        <td><input class="easyui-passwordbox" type="text" id="password" name="password">
        </td>
    </tr>
    <tr style="height: 38px; vertical-align: top;">
        <td class="textbox-label" style="width: 74px;"><spring:message code="RepeatNewPassword"/>:</td>
