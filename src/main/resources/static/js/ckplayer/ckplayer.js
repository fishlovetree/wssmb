...
function ckplayerConfig() {
	return {
		...
		config: {
			...
			definition: false, //true 是否使用清晰度组件(lmn-修改)
			smartRemove: true, //是否使用智能清理，使用该功能则在多段时当前播放段之前的段都会被清除出内存，减少对内存的使用
			bufferTime: 0, //200/0 缓存区的长度，单位：毫秒,不要小于10(lmn-修改)
			...
			timeScheduleAdjust: 0, //1 是否可调节调节栏,0不启用，1是启用，2是只能前进（向右拖动），3是只能后退，4是只能前进但能回到第一次拖动时的位置，5是看过的地方可以随意拖动(lmn-修改)
			...
			liveAndVod: { //直播+点播=回播功能
				open: true, //是否开启，开启该功能需要设置flashvars里live=true(lmn-修改)
				vodTime: 2, //可以回看的整点数
				start: 'start' //回看请求参数
			},
			errorNum: 3, //错误重连次数
			playCorrect: true, //是否需要错误修正，这是针对rtmp的(lmn-修改)
		...
		style: { //风格部分内容配置，这里主要配置loading和logo以及广告的部分内容
			loading: {
				...
				file:'data:image/swf;base64,',
				align: 'center',
				vAlign: 'middle',
				offsetX: -300,
				offsetY: -150
